...
function resetAll() {
    selectedInfo = 0, headerInfo = {}, headerInfo.response = [], headerInfo.request = [], $("#result").empty(), $("#responseList > tbody").empty(), $("#previewArea").empty().html(defaultText)
}
...
var headerInfo = {}, settings = {}, tabId = "",
    selectedInfo = 0,
    captureTraffic = !0,
    defaultText = "";
$(function () {
    headerInfo.response = [], headerInfo.request = [], defaultText = $("#previewArea").html(), 
    /*
    ...
    }, ["blocking", "responseHeaders"]), chrome.webRequest.onSendHeaders.addListener(function (n) {
    ...
    */
    $("#responseList").click(function (n) {
        if (n.toElement.nodeName.toLowerCase() == "td" || n.toElement.nodeName.toLowerCase() == "input" || n.toElement.nodeName.toLowerCase() == "span") {
            ...
            $(n.toElement).closest("tr").children("td").children("input").select(), selectedInfo = t, showInfo(t)
        }
    }), 
    /*
